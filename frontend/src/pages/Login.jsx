            ...
            <div className="px-8 py-8">
              ...
              {loading ? (
                <div className="flex items-center justify-center py-6">
                  ...
                  <span className="ml-3 text-white/70 text-sm">Signing in...</span>
                </div>
              ) : (
                <button
                  onClick={login}
                  className="group w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-800 font-medium py-3.5 px-5 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5 cursor-pointer active:translate-y-0"
                >
