  ...
  return (
    <div className="flex flex-col gap-[15px] p-[15px] pb-[30px]">
      ...
      <div className="bg-[#fcfdfd] border border-[#ccc] border-solid flex flex-col p-[30px]">
        <div className="bg-white border border-[#eef0ef] border-solid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-[30px] p-[30px] rounded-[15px] shadow-[0px_2px_2px_0px_rgba(0,0,0,0.25)] justify-items-center">
          <p className="font-['Avenir:Heavy',sans-serif] text-[#161616] text-[18px] col-span-full justify-self-start">
            Recent Proposals
          </p>
          ...
          {error && (
            <p className="font-['Avenir:Roman',sans-serif] text-red-500 text-[16px] col-span-full">
              Error loading proposals: {error}
            </p>
          )}

          {!loading && !error && proposals.length === 0 && (
            <div className="border border-[#999] border-solid flex gap-[10px] items-center px-[15px] py-[10px] rounded-[26px] col-span-full">
